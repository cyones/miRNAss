...
%------------------------------------------------------------
\title{Using \Rpackage{miRNAss} to discover pre-miRNA in genome-wide data from few labeled
examples}
%------------------------------------------------------------
...
Intelligence, sinc(\textit{i}), FICH-UNL, CONICET, Santa Fe (3000), Argentina.}
...
a tool specifically designed for this task. For the feature extraction there are
many tools available that can calculate different sets of features. We have
...
prediction methods. For further details on \textit{miRNAfe} see Yones
